...
#line 73 "phase3.y"
              ...
              oss << (yyvsp[-1].statement).code << (yyvsp[0].statement).code << std::endl;
              
              (yyval.statement).code = oss.str();
            }
#line 1479 "phase3.tab.c"
    break;

  case 3:
#line 80 "phase3.y"
            { printf("program -> epsilon\n"); }
#line 1485 "phase3.tab.c"
    break;
